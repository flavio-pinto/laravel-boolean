...
$(document).ready(function () {
  ...
  var filter = $('#filter');
  var apiUrl = window.location.protocol + '//' + window.location.host + '/api/students/genders'; //Init Handlebars

  var source = $('#student-template').html();
  var template = Handlebars.compile(source);
  filter.on('change', function () {
    var gender = $(this).val(); //Chiamata Ajax
...
__webpack_require__(/*! E:\Boolean\Lezioni\082-Laravel-sito-Boolean\laravel-boolean\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! E:\Boolean\Lezioni\082-Laravel-sito-Boolean\laravel-boolean\resources\sass\app.scss */"./resources/sass/app.scss");
