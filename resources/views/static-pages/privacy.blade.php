...
@section('main-content')
    ...
    <h3 class="privacy__subtitle">Natura dei dati trattati</h3>
    <p class="privacy__parag">
...
Il mancato trattamento di alcuni dati (es. i dati di contatto, o gli indirizzi, o dati sul comportamento o sulle preferenze dell’utente ecc.) potrebbe rendere impossibile la prestazione dei servizi da parte del Sito. Se l’Utente utilizza il Sito per pubblicare o comunque condividere dati personali di terzi, (Interessati diversi dall’Utente) ne assume le relative responsabilità. In tal senso, l’Utente garantisce di avere il diritto di comunicare o diffondere i dati personali dei terzi e di averli previamente informati del trattamento, sollevando il Sito da ogni responsabilità per il loro trattamento strumentale in seguito alla loro comunicazione o diffusione.
    ...
    <h3 class="privacy__subtitle">Finalità del trattamento</h3>
    <p class="privacy__parag">
        I Dati dell’Utente o dell’Interessato sono raccolti per consentire:
    </p>
    <ul class="privacy__list">
        <li class="privacy__list__item">l’erogazione del servizio;</li>
        <li class="privacy__list__item">la risposta a specifiche richieste informative dell’Utente;</li>
        <li class="privacy__list__item">l’aggiornamento dell’Utente sui nuovi prodotti o servizi erogati dal Sito o in relazione a particolari offerte commerciali;</li>
        <li class="privacy__list__item">l’informazione dell’Utente in occasione di manutenzione sul Sito o di eventuali disservizi;</li>
        <li class="privacy__list__item">l’eventuale profilazione commerciale dell’Utente;</li>
        <li class="privacy__list__item">la visualizzazione di banner pubblicitari in relazione agli interessi dell’Utente (behavioral targeting/advertising);</li>
        <li class="privacy__list__item">la difesa da parte del Titolare del Sito, in giudizio o nelle fasi propedeutiche alla sua eventuale instaurazione, da abusi nell’utilizzo dello stesso o dei servizi connessi da parte dell’Utente.</li>
    </ul>

    <h3 class="privacy__subtitle">Base giuridica e consenso</h3>
    <p class="privacy__parag">
        I Suoi dati personali potranno essere trattati dal Titolare in caso sussista una delle seguenti condizioni:
    </p>
    <ul class="privacy__list">
        <li class="privacy__list__item">sia stato prestato il consenso per una o più finalità specifiche ai sensi dell’art. 6 lett. a) del GDPR (ad esempio nel caso di invio di comunicazioni promozionali, profilazione commerciale, behavioral advertising, geolocalizzazione ecc.);</li>
        <li class="privacy__list__item">il trattamento è necessario all'esecuzione di un contratto con l’Utente e/o all'esecuzione di misure precontrattuali ai sensi dell’art. 6 lett. b) del GDPR;</li>
        <li class="privacy__list__item">il trattamento è necessario per adempiere un obbligo legale al quale è soggetto il Titolare ai sensi dell’art. 6 lett. c) del GDPR;</li>
        <li class="privacy__list__item">il trattamento è necessario per il perseguimento del legittimo interesse del Titolare o di terzi.</li>
    </ul>
    <p class="privacy__parag">
        È comunque sempre possibile richiedere al Titolare di chiarire la concreta base giuridica di ciascun trattamento ed in particolare di specificare se il trattamento sia basato sulla legge, previsto da un contratto o necessario per concludere un contratto.
    </p>

    <h3 class="privacy__subtitle">Modalità di trattamento dei dati</h3>
    <p class="privacy__parag">
...
I dati sono inoltre protetti mediante misure tecniche ed organizzative per assicurare idonei livelli di sicurezza e riservatezza ai sensi degli artt. 25 e 32 del GDPR.  
    ...
    <h3 class="privacy__subtitle">Diffusione, Comunicazione dei dati e destinatari</h3>
    <p class="privacy__parag">
...
I dati personali potranno invece essere utilizzati, per le finalità precedentemente esposte o per finalità ulteriori, da soggetti terzi, di seguito indicati, che prestano servizi che consentono al Sito di gestire e monitorare elenchi d’indirizzi email utilizzati per comunicare con l’Utente tramite posta elettronica:
    ...
    <ul class="privacy__list">
        ...
        <li class="privacy__list__item">
            Soggetti che forniscono servizi di statistica che tengono traccia del comportamento dell’Utente ed, in caso di profilazione, possono richiedere il consenso espresso dell’Utente (Google Analytics, Social Plugin, Google + …).
        </li>
    </ul>

    <h3 class="privacy__subtitle">Link ad altri Siti Web</h3>
    <p class="privacy__parag">
    ...
    <h3 class="privacy__subtitle">Definizioni e riferimenti legali</h3>
    <p class="privacy__parag">
    ...
    <ul class="privacy__list">
        <li class="privacy__list__item">Chrome: <a href="#">Link</a></li>
        <li class="privacy__list__item">Firefox: <a href="#">Link</a></li>
        <li class="privacy__list__item">Internet Explorer: <a href="#">Link</a></li>
        <li class="privacy__list__item">Opera: <a href="#">Link</a></li>
        <li class="privacy__list__item">Safari: <a href="#">Link</a></li>
    </ul>
    <p class="privacy__parag">
        Se decidi di non abilitare i cookies, la tua esperienza su boolean.careers potrebbe essere limitata.
    </p>

    <h3 class="privacy__subtitle">Trasferimento dei dati personali extra UE</h3>
    <p class="privacy__parag">
    ...
    <h3 class="privacy__subtitle">Conservazione dei dati</h3>
    <p class="privacy__parag">
    ...
    <h3 class="privacy__subtitle">Diritti dell’interessato</h3>
    <p class="privacy__parag">
